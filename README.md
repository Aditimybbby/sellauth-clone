...
![Next.js](https://img.shields.io/Next.js-15-black)
![TypeScript](https://img.shields.io/TypeScript-5.5-blue)

## Features

- **Product Management** — Sell license keys, digital files, and services
...
- **Admin Dashboard** — Revenue analytics, order management, customer CRM, support tickets
- **Coupons & Discounts** — Percentage and fixed-amount discount codes
- **Customer Reviews** — Star ratings and comments on products
- **Fraud Protection** — IP/email blacklisting and rate limiting
- **Dark Theme** — Modern dark UI built with shadcn/ui + Tailwind CSS 4
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/Aditimybbby/sellauth-clone.git
   cd sellauth-clone
   ```
...
4. **Seed the database (optional, adds demo products):**
   ```bash
   npm run db:seed
   ```
...
3. Add to `.env`:
   ...
   CRYPTO_WEBHOOK_SECRET=random-string
   ```
